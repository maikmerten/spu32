    ...
    #define DEV_UART_RX_READY 0xFFFFF804
    #define DEV_UART_TX_READY 0xFFFFF808

    #define DEV_SPI_DATA 0xFFFFF900
    #define DEV_SPI_SELECT 0xFFFFF904
    #define DEV_SPI_READY 0xFFFFF908

    #define DEV_TIMER 0xFFFFFD00
    #define DEV_TIMER_INTERRUPT 0xFFFFFD04

    #define DEV_LED 0xFFFFFFFD
